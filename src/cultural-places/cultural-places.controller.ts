...
export class CulturalPlacesController {
  ...
  @ApiResponse({
    status: 201,
    description: 'Cultural place created successfully',
  })
  @ApiResponse({ status: 400, description: 'Bad request - validation error' })
  @ApiResponse({
    status: 409,
    description: 'Conflict - place with same name already exists',
  })
  async create(@Body() createCulturalPlaceDto: CreateCulturalPlaceDto) {
    try {
      console.log(
        'Controller received data:',
        JSON.stringify(createCulturalPlaceDto, null, 2),
      );
  ...
  @ApiResponse({
    status: 200,
    description: 'List of cultural places retrieved successfully',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Nearby cultural places found successfully',
  })
  async findNearby(
  ...
  @ApiResponse({
    status: 200,
    description: 'Cultural places by category retrieved successfully',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Cultural places open on specific day retrieved successfully',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Top rated cultural places retrieved successfully',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Cultural place retrieved successfully',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Cultural place updated successfully',
  })
  @ApiResponse({ status: 404, description: 'Cultural place not found' })
  @ApiResponse({ status: 400, description: 'Bad request - validation error' })
  async update(
  ...
  @ApiResponse({
    status: 200,
    description: 'Cultural place cancelled successfully',
  })
  @ApiResponse({ status: 404, description: 'Cultural place not found' })
  ...
  @ApiResponse({
    status: 200,
    description: 'Cultural places cancelled successfully',
  })
  @ApiResponse({
    status: 404,
    description: 'No cultural places found within range',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Cultural place activated successfully',
  })
  @ApiResponse({ status: 404, description: 'Cultural place not found' })
  async activateByLocation(
    @Body() payload: ActivateCulturalPlaceByLocationDto,
  ) {
    return this.culturalPlacesService.activateByLocation(payload);
  }

  @Post('activate-by-range')
  @ApiOperation({
    summary: 'Activate multiple cultural places inside a radius',
  })
  @ApiResponse({
    status: 200,
    description: 'Cultural places activated successfully',
  })
  @ApiResponse({
    status: 404,
    description: 'No cultural places found within range',
  })
  async activateByRange(@Body() payload: ActivateCulturalPlacesByRangeDto) {
    return this.culturalPlacesService.activateByRange(payload);
  }
}
